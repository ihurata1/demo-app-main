...
public inline fun rawGps(block: io.mavsdk.telemetry.RawGpsKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.RawGps =
  io.mavsdk.telemetry.RawGpsKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.RawGps.newBuilder()).apply { block() }._build()
/**
 * ```
 *
 ...
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.RawGps`
 */
public object RawGpsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.RawGps.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.RawGps.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.RawGps = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.RawGps.copy(block: `io.mavsdk.telemetry`.RawGpsKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.RawGps =
  `io.mavsdk.telemetry`.RawGpsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
