...
public inline fun missionItem(block: io.mavsdk.mission_raw_server.MissionItemKt.Dsl.() -> kotlin.Unit): io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem =
  io.mavsdk.mission_raw_server.MissionItemKt.Dsl._create(io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem.newBuilder()).apply { block() }._build()
/**
 * ```
 * Mission item exactly identical to MAVLink MISSION_ITEM_INT.
 * ```
 *
 * Protobuf type `mavsdk.rpc.mission_raw_server.MissionItem`
 */
public object MissionItemKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem = _builder.build()
...
public inline fun io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem.copy(block: `io.mavsdk.mission_raw_server`.MissionItemKt.Dsl.() -> kotlin.Unit): io.mavsdk.mission_raw_server.MissionRawServerProto.MissionItem =
  `io.mavsdk.mission_raw_server`.MissionItemKt.Dsl._create(this.toBuilder()).apply { block() }._build()
