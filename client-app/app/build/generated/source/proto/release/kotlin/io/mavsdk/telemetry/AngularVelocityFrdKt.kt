...
public inline fun angularVelocityFrd(block: io.mavsdk.telemetry.AngularVelocityFrdKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd =
  io.mavsdk.telemetry.AngularVelocityFrdKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd.newBuilder()).apply { block() }._build()
/**
 * ```
 * AngularVelocityFrd message type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.AngularVelocityFrd`
 */
public object AngularVelocityFrdKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd.copy(block: `io.mavsdk.telemetry`.AngularVelocityFrdKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.AngularVelocityFrd =
  `io.mavsdk.telemetry`.AngularVelocityFrdKt.Dsl._create(this.toBuilder()).apply { block() }._build()
