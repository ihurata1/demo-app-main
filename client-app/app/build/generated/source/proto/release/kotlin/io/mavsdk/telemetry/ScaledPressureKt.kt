...
public inline fun scaledPressure(block: io.mavsdk.telemetry.ScaledPressureKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.ScaledPressure =
  io.mavsdk.telemetry.ScaledPressureKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.ScaledPressure.newBuilder()).apply { block() }._build()
/**
 * ```
 * Scaled Pressure message type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.ScaledPressure`
 */
public object ScaledPressureKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.ScaledPressure.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.ScaledPressure.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.ScaledPressure = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.ScaledPressure.copy(block: `io.mavsdk.telemetry`.ScaledPressureKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.ScaledPressure =
  `io.mavsdk.telemetry`.ScaledPressureKt.Dsl._create(this.toBuilder()).apply { block() }._build()
