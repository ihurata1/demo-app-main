...
public inline fun actuatorControlTarget(block: io.mavsdk.telemetry.ActuatorControlTargetKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget =
  io.mavsdk.telemetry.ActuatorControlTargetKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget.newBuilder()).apply { block() }._build()
/**
 * ```
 * Actuator control target type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.ActuatorControlTarget`
 */
public object ActuatorControlTargetKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget.copy(block: `io.mavsdk.telemetry`.ActuatorControlTargetKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.ActuatorControlTarget =
  `io.mavsdk.telemetry`.ActuatorControlTargetKt.Dsl._create(this.toBuilder()).apply { block() }._build()
