...
public inline fun positionNed(block: io.mavsdk.telemetry.PositionNedKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.PositionNed =
  io.mavsdk.telemetry.PositionNedKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.PositionNed.newBuilder()).apply { block() }._build()
/**
 * ```
 * PositionNed message type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.PositionNed`
 */
public object PositionNedKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.PositionNed.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.PositionNed.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.PositionNed = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.PositionNed.copy(block: `io.mavsdk.telemetry`.PositionNedKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.PositionNed =
  `io.mavsdk.telemetry`.PositionNedKt.Dsl._create(this.toBuilder()).apply { block() }._build()
