...
public inline fun odometry(block: io.mavsdk.telemetry_server.OdometryKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry_server.TelemetryServerProto.Odometry =
  io.mavsdk.telemetry_server.OdometryKt.Dsl._create(io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.newBuilder()).apply { block() }._build()
/**
 * ```
 * Odometry message type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry_server.Odometry`
 */
public object OdometryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry_server.TelemetryServerProto.Odometry = _builder.build()
     ...
     */
    public var frameId: io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.MavFrame
      @JvmName("getFrameId")
     ...
     */
    public var childFrameId: io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.MavFrame
     ...
     */
    public var positionBody: io.mavsdk.telemetry_server.TelemetryServerProto.PositionBody
     ...
     */
    public var q: io.mavsdk.telemetry_server.TelemetryServerProto.Quaternion
      @JvmName("getQ")
      get() = _builder.getQ()
      @JvmName("setQ")
      set(value) {
     ...
     */
    public var velocityBody: io.mavsdk.telemetry_server.TelemetryServerProto.VelocityBody
     ...
     */
    public var angularVelocityBody: io.mavsdk.telemetry_server.TelemetryServerProto.AngularVelocityBody
     ...
     */
    public var poseCovariance: io.mavsdk.telemetry_server.TelemetryServerProto.Covariance
     ...
     */
    public var velocityCovariance: io.mavsdk.telemetry_server.TelemetryServerProto.Covariance
...
public inline fun io.mavsdk.telemetry_server.TelemetryServerProto.Odometry.copy(block: `io.mavsdk.telemetry_server`.OdometryKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry_server.TelemetryServerProto.Odometry =
  `io.mavsdk.telemetry_server`.OdometryKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.positionBodyOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.PositionBody?
  get() = if (hasPositionBody()) getPositionBody() else null

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.qOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.Quaternion?
  get() = if (hasQ()) getQ() else null

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.velocityBodyOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.VelocityBody?
  get() = if (hasVelocityBody()) getVelocityBody() else null

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.angularVelocityBodyOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.AngularVelocityBody?
  get() = if (hasAngularVelocityBody()) getAngularVelocityBody() else null

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.poseCovarianceOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.Covariance?
  get() = if (hasPoseCovariance()) getPoseCovariance() else null

public val io.mavsdk.telemetry_server.TelemetryServerProto.OdometryOrBuilder.velocityCovarianceOrNull: io.mavsdk.telemetry_server.TelemetryServerProto.Covariance?
