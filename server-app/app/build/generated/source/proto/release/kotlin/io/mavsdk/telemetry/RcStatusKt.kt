...
public inline fun rcStatus(block: io.mavsdk.telemetry.RcStatusKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.RcStatus =
  io.mavsdk.telemetry.RcStatusKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.RcStatus.newBuilder()).apply { block() }._build()
/**
 * ```
 * Remote control status type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.RcStatus`
 */
public object RcStatusKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.RcStatus.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.RcStatus.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.RcStatus = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.RcStatus.copy(block: `io.mavsdk.telemetry`.RcStatusKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.RcStatus =
  `io.mavsdk.telemetry`.RcStatusKt.Dsl._create(this.toBuilder()).apply { block() }._build()
