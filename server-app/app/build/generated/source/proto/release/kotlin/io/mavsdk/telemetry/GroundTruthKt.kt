...
public inline fun groundTruth(block: io.mavsdk.telemetry.GroundTruthKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.GroundTruth =
  io.mavsdk.telemetry.GroundTruthKt.Dsl._create(io.mavsdk.telemetry.TelemetryProto.GroundTruth.newBuilder()).apply { block() }._build()
/**
 * ```
 * GroundTruth message type.
 * ```
 *
 * Protobuf type `mavsdk.rpc.telemetry.GroundTruth`
 */
public object GroundTruthKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: io.mavsdk.telemetry.TelemetryProto.GroundTruth.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: io.mavsdk.telemetry.TelemetryProto.GroundTruth.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): io.mavsdk.telemetry.TelemetryProto.GroundTruth = _builder.build()
...
public inline fun io.mavsdk.telemetry.TelemetryProto.GroundTruth.copy(block: `io.mavsdk.telemetry`.GroundTruthKt.Dsl.() -> kotlin.Unit): io.mavsdk.telemetry.TelemetryProto.GroundTruth =
  `io.mavsdk.telemetry`.GroundTruthKt.Dsl._create(this.toBuilder()).apply { block() }._build()
